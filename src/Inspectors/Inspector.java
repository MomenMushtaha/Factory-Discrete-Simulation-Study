...
public class Inspector {
    ...
    public Inspector(Integer Id, double averageTime){
        this.Id = Id;
        this.averageTime = averageTime;
        getAverageTime();
        //buffer statement add here
    }


    //constructor for inspector2
    public Inspector(Integer Id, double averageTime22, double averageTime23){
        this.Id = Id;
    ...
    public  double getAverageTime(){
        System.out.println("ins1:buf1 avg = " + averageTime + "\n");
        return averageTime;
    }
}
